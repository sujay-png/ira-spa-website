export const facialEssentialGroups = [
    {
        heading: "Clean-Ups",
        treatments: [
            {
        ...
        treatments: [
            {
                ...
                description:
                    "Moisturize and soothe your delicate and dry skin with comfort and protection.",
                ...
                prices: [{ label: "45 min", price: "₹1,000" }],
            },
            {
                ...
                category: "Facial-Essential",
                description:
                    "Revitalize to leave a supple skin by proper exfoliation and enhanced blood circulation.",
                ...
                prices: [{ label: "45 min", price: "₹1,200" }],
            },
            {
                slug: "herbal-pearl",
                name: "Herbal Pearl",
                category: "Facial-Essential",
                description:
                    "A natural retreat for your skin from hand-picked herbal ingredients.",
                ...
                prices: [{ label: "45 min", price: "₹2,000" }],
            },
        ],
    },
];