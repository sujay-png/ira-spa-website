export const quickMassageTreatments = [
    {
        slug: "foot-reflexology",
        name: "Foot Reflexology",
        category: "Express Rituals",
        description:
            "Stimulate and massage pressure points in legs to release the tension and relax tired legs.",
        ...
        prices: [{ label: "30 min", price: "₹1,200" }],
    },
    {
        slug: "back-massage",
        name: "Back",
        ...
        prices: [{ label: "30 min", price: "₹1,600" }],
    },
    {
